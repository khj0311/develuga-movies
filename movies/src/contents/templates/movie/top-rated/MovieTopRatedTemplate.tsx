        ...
        return (
            <Box className='tmdb-content-wrap' sx={{ margin: 'auto', maxWidth: '1440px' }}>
                <Box className='tmdb-content-header'>
                    <h2 className='tmdb-content__main-title'>Top Rated Movies</h2>
                </Box>
                <Box className='tmdb-content-main'>
                    <Box sx={{ flexGrow: 1 }}>
                        <CardList type={'movieList'} data={data.movieListTopRated} genres={movieGenres.movieListGenres} />
                    </Box>
                </Box>
            </Box>
        );
...
export default MovieTopRatedTemplate;

        ...
        return (
            <Box className='tmdb-content-wrap' sx={{ margin: 'auto', maxWidth: '1440px' }}>
                <Box className='tmdb-content-header'>
                    <h2 className='tmdb-content__main-title'>Currently Airing TV Shows</h2>
                </Box>
                <Box className='tmdb-content-main'>
                    <Box sx={{ flexGrow: 1 }}>
                        <CardList type={'tvList'} data={data.tvListOnTv} genres={tvGenres.tvListGenres} />
                    </Box>
                </Box>
            </Box>
        );
